# qtx-0036: Speed up Windows CI and align registry usage

> Migrated from `autonomy/tasks/qtx-0036-speed-up-windows-ci-and-align-registry.md` on 2026-04-27. This is completed task history preserved as an archived OpenSpec change.
...
| Docs to update | docs/runbooks/releasing-quantex.md |
