# qtx-0032: Verify beta release channel

> Migrated from `autonomy/tasks/qtx-0032-verify-beta-release-channel.md` on 2026-04-27. This is completed task history preserved as an archived OpenSpec change.
...
| Priority | `high` |
| Area | release |
| Depends on | qtx-0030, qtx-0031 |
| Human review | `required` |
| Docs to update | release-please-config.beta.json, .github/workflows/release.yml |
