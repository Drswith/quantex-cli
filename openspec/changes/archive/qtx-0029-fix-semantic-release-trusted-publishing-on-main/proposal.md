# qtx-0029: Fix semantic-release trusted publishing on main

> Migrated from `autonomy/tasks/qtx-0029-fix-semantic-release-trusted-publishing-on-main.md` on 2026-04-27. This is completed task history preserved as an archived OpenSpec change.
