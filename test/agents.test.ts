...
import { buildAgentCatalogManifest, readCatalogEntries } from '../scripts/build/write-agent-catalog-manifest'
...
describe('cursor', () => {
  it('has valid structure', () => {
    ...
    expect(cursor.versionProbe?.preferredBinaries).toEqual(['cursor-agent'])
