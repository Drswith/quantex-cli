...
目标不是把 CLI 变得“没人味”，而是让同一个工具既适合人直接使用，也适合作为 agent orchestration 的基础设施。
...
Quantex 未来若要被多个 agent 或多个 workflow 同时调用，需要提前考虑：
...
“默认对人类友好，同时对 AI agent 具有稳定契约的双模 CLI”
