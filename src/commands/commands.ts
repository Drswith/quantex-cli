...
const commandCatalog: CommandDescriptor[] = [
  {
    ...
    name: 'capabilities',
    outputSchemaRef: '#/commands/capabilities',
    stability: 'stable',
  ...
  },
  {
    ...
    name: 'commands',
    outputSchemaRef: '#/commands/commands',
    stability: 'stable',
  ...
  },
  {
    ...
    name: 'config',
    outputSchemaRef: '#/commands/config',
    stability: 'stable',
  ...
  },
  {
    ...
    name: 'doctor',
    outputSchemaRef: '#/commands/doctor',
    stability: 'stable',
  ...
  },
  {
    ...
    name: 'ensure',
    outputSchemaRef: '#/commands/ensure',
    stability: 'stable',
  ...
  },
  {
    flags: ['--json', '--output', '--quiet', '--color', '--log-level', '--refresh', '--no-cache', '--timeout'],
    name: 'inspect',
    outputSchemaRef: '#/commands/inspect',
    stability: 'stable',
  ...
  },
  {
    flags: ['--json', '--output', '--quiet', '--color', '--log-level', '--refresh', '--no-cache', '--timeout'],
    name: 'resolve',
    outputSchemaRef: '#/commands/resolve',
    stability: 'stable',
  ...
  },
  {
    flags: ['--json', '--output', '--quiet', '--color', '--log-level', '--timeout'],
    name: 'schema',
    outputSchemaRef: '#/commands/schema',
    stability: 'stable',
  ...
  },
  {
    ...
    name: 'update',
    outputSchemaRef: '#/commands/update',
    stability: 'stable',
  ...
  },
  {
    ...
    name: 'uninstall',
    outputSchemaRef: '#/commands/uninstall',
    stability: 'stable',
  ...
  },
  {
    ...
    name: 'upgrade',
    outputSchemaRef: '#/commands/upgrade',
    stability: 'stable',
