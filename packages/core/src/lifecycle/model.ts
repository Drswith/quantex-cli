...
// packages/core/src/state may share this module without depending on Core runtime (ADR 0011).
...
// packages/core/src/state (ADR 0011). Not a leftover; do not restore src/lifecycle.
