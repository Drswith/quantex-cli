...
- 改 lifecycle 收据类型 / provider-binding 内化 / Core 内部 lifecycle：
  `src/core/lifecycle/`、`src/lifecycle/`、`openspec/specs/runtime-boundaries/spec.md`、`docs/adr/0011-core-internal-lifecycle-model-leaf.md`、`docs/adr/0012-core-internal-lifecycle-provider-binding.md`
